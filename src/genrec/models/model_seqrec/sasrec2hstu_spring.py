"""SeqRec Model: SASRec -> HSTU with Spring regularization."""
...
@SeqRecModelConfigFactory.register("sasrec2hstu_spring")
class SASRec2HSTUSpringModelConfig(SASRecModelConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            learnable_input_pos_emb (bool): Whether to use learnable positional embeddings
...
@dataclass
class SASRec2HSTUSpringModelOutput(SASRecModelOutput):
    """Output class for SASRec model with Spring regularization.

    The `SASRec2HSTUSpringModelOutput` extends the `SASRecModelOutput`
...
@SeqRecModelFactory.register("sasrec2hstu_spring")
class SASRec2HSTUSpringModel(SeqRecModel[SASRec2HSTUSpringModelConfig, SASRec2HSTUSpringModelOutput]):
    """SASRec model with Spring regularization.

    Here we reuse the `SASRecModel` network architecture and add Spring regularization
    as the `model_loss` in the `SASRec2HSTUSpringModelOutput`.
    ...
    config_class = SASRec2HSTUSpringModelConfig

    def __init__(self, config: SASRec2HSTUSpringModelConfig) -> None:
        """Initializes SASRec model with the given configuration."""
        super().__init__(config)
        self.config: SASRec2HSTUSpringModelConfig
        ...
        if config.learnable_input_pos_emb:
    ...
    def forward(
        ...
        **kwargs,
        ...
        Returns:
            SASRec2HSTUSpringModelOutput: Model outputs packaged as a `SASRec2HSTUSpringModelOutput` descendant.
        """
        ...
        if self.input_pos_emb is not None:
        ...
        return SASRec2HSTUSpringModelOutput(
